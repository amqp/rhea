...
(function (SessionEvents) {
     ...
     */
    SessionEvents['receiverError'] = 'receiver_error';
    /**
     ...
     */
    SessionEvents['receiverClose'] = 'receiver_close';
    /**
     ...
     */
    SessionEvents['senderError'] = 'sender_error';
    /**
     ...
     */
    SessionEvents['senderClose'] = 'sender_close';
...
(function (ConnectionEvents) {
     ...
     */
    ConnectionEvents['sessionError'] = 'session_error';
    /**
     * @property {string} sessionClose Raised when the remote peer indicates that the session is
     * closed and the event was not handled on the session.
     */
    ConnectionEvents['sessionClose'] = 'session_close';
    /**
