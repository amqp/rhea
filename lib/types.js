...
types.Reader.prototype.read_array = function (type) {
    var limits = this.read_size_count(type.width);
    var constructor = this.read_constructor();
    var value = new type(this.read_multiple(limits.count, function (b) { b.read_value(get_type(constructor.typecode)); }), constructor.typecode, constructor.descriptor);
    return value;
}
